...
export const level2 = (): World => ({
  ...
  platforms: [
    { position: { x: 0, y: 430 }, size: { width: 230, height: 50 } },
    { position: { x: 345, y: 430 }, size: { width: 190, height: 50 } },
    { position: { x: 650, y: 430 }, size: { width: 165, height: 50 } },
    { position: { x: 930, y: 430 }, size: { width: 215, height: 50 } },
    { position: { x: 1260, y: 430 }, size: { width: 180, height: 50 } },
    { position: { x: 1555, y: 430 }, size: { width: 245, height: 50 } },
